...
**Created:** 2026-04-03 by Nova + Tela (claude.ai session)
**Purpose:** Track what the organism needs next. PRs reference this.

## Done
- [x] Hourly pulse running on juuri (2026-02-14)
- [x] SMHI weather + daylight data sources
- [x] Multi-mind config architecture (tela/nowa/tecton)
- [x] Budget management and daily caps
- [x] Post-nursery phase transition (2026-04-03)
- [x] Buffer: Tela can propose changes to Nova
...
- The organism participates in its own evolution
- Infrastructure before theory
